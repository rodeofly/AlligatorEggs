...
(function() {
  ...
  FUNCTION = {
    ...
    "SUB-rec": "(λf.( λx.( f (x x ) ) λx.( f (x x ) ) ) )   (λr.λm.λn.    ((λn.n (λx.(λa.λb.b)) (λa.λb.a)) n)                      m                      (r ( (λa.λf.λx.a (λg.λh.h (g f)) (λu.x) (λu.u)) m) ( (λa.λf.λx.a (λg.λh.h (g f)) (λu.x) (λu.u)) n)))",
    "TRUE": "(λa.λb.a)",
    "FALSE": "(λa.λb.b)",
    "AND": "(λp.λq.p q p)",
    "OR": "(λp.λq.p p q)",
  ...
  $(function() {
    ...
    $(".panel-button").on("click", function() {
      var looping, parentheses, _k, _len2, _ref1, _results;

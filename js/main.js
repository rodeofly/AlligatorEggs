...
(function() {
  var ALPHABET, CSS_COLOR_NAMES, EXERCICES, FUNCTION, ahead_vars, color_tab, debug, delay, delta, id, infobox, interval, looping, renderArbor, tags, var_tab, _ref,
  ...
  _ref = [[], [], {}, true, false, false, false, true, 0, 550], color_tab = _ref[0], ahead_vars = _ref[1], var_tab = _ref[2], renderArbor = _ref[3], looping = _ref[4], debug = _ref[5], infobox = _ref[6], tags = _ref[7], id = _ref[8], delta = _ref[9];
  ...
  FUNCTION = {
    ...
    "SUBR": "(λf.( λx.( f (x x ) ) λx.( f (x x ) ) ) )   (λr.λm.λn.    ((λn.n (λx.(λa.λb.b)) (λa.λb.a)) n)                      m                      (r ( (λa.λf.λx.a (λg.λh.h (g f)) (λu.x) (λu.u)) m) ( (λa.λf.λx.a (λg.λh.h (g f)) (λu.x) (λu.u)) n)))",
    "TRUE": "(λa.λb.a)",
    "FALSE": "(λa.λb.b)",
    "AND": "(λp.λq.p q p)",
    "OR": "(λp.λq.p p q)",
  ...
  $(function() {
    var animation_eating_application, animation_kill, color, color_rule_check, create_edges_for_heritier, draw_lambda_expression, egg_def, find_action_pointer, get_lambda_from, go_one_step, help, index, inserer, insert_exp_into_div, insert_item, key, letter, make_dropped_droppable, open_def, preparer_exercice, render_viewport, resize, sys, transform_div_to_node, value, _i, _j, _len, _len1;
    ...
    find_action_pointer = function(root) {
      ...
      while (pointer.length > 0) {
        if (local_debug) {
          console.log("stay for a loop with " + (pointer.attr('data-variable')));
        }
    ...
    create_edges_for_heritier = function(ancestor, mode) {
      var heritier, local_debug, next, parent, previous;
      if (mode == null) {
        mode = "normal";
      }
      local_debug = true;
      ...
      if ((ancestor.length > 0) && (mode !== "self")) {
    ...
    render_viewport = function() {
      return {
        ...
        step2: function(pointer) {
          ...
          local_debug = true;
          if (local_debug) {
            console.log("step 2 : LE CROCO BLANC !");
          }
        ...
        step4: function(pointer, application) {
          ...
          local_debug = true;
          if (local_debug) {
            console.log("step 4 : ON MANGE L'APPLICATION !");
          }
          application.find(".dropped").addBack(".dropped").each(function() {
        ...
        step5: function(egg, application) {
          ...
          if (application.length > 0) {
            ...
            return create_edges_for_heritier(egg);
          }
        }
      };
    };
      ...
      step4.done(function(app, eggs, variable) {
        ...
        if (n > 0) {
          ...
          eggs.each(function(index, element) {
            ...
            appClone = app.clone();
            appClone.find(".dropped").addBack().each(function() {

...
(function() {
  var ALPHABET, CSS_COLOR_NAMES, EXERCICES, FUNCTION, color_tab, debug, delay, id, interval, parentheses, speed, var_tab, _ref,
    ...
    go_one_step = function(root) {
      ...
      if ((pointer.hasClass("lambda")) && (pointer.attr("data-color") !== "white") && (pointer.next().length > 0)) {
        ...
        (color_rule_check = function(pointer, application) {
          var $var, application_vars, find_tree, function_vars, get_vars, index, intersect, intersection, item, palette, _i, _len;
